 ...
 */
final class Version20230217100725 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD rdv_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE rdv ADD client_id INT NOT NULL');
